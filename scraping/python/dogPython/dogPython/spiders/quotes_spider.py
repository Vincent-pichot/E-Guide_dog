...
class fullSplitSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        self.log(f'File {filename}-img saved')
        ...
        self.log(f'File {filename}-div saved')
        ...
        self.log(f'File {filename}-p saved')
        ...
        self.log(f'File {filename}-form saved')
        ...
        self.log(f'File {filename}-table saved')
        ...
        self.log(f'File {filename}-ul saved')
        ...
        self.log(f'File {filename}-input saved')
        ...
        self.log(f'File {filename}-label saved')
        ...
        self.log(f'File {filename}-span saved')
        ...
        self.log(f'File {filename}-button saved')
